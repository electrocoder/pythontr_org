...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('posts_post', 'tags', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Post.tags'
        db.alter_column('posts_post', 'tags', self.gf('django.db.models.fields.TextField')(max_length=20))
