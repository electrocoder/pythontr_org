...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('posts_post', 'tags', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Post.tags'
        db.alter_column('posts_post', 'tags', self.gf('django.db.models.fields.CharField')(default='tag1, tag2', max_length=100))
