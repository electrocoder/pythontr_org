...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('posts_category', 'image', self.gf('django.db.models.fields.files.ImageField')(default='category_images/django_square_logo.png', max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Category.image'
        db.alter_column('posts_category', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
