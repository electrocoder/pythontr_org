...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_profile', (
            ...
            ('web_site', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('about', self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True)),
