...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('polls_poll', 'slug', self.gf('django.db.models.fields.SlugField')(default='Favori GUI k\xc3\xbct\xc3\xbcphaneniz nedir?', max_length=200, db_index=True), keep_default=False)
